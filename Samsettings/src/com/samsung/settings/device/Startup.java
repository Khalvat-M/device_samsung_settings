...
import com.samsung.settings.device.utils.FileUtils;
...
public class Startup extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        enabled = sharedPrefs.getBoolean(Constants.KEY_SAMSUNG_SWITCH, false);
        restore(SamsungModeSwitch.getFile(), enabled);
